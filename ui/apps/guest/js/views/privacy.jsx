...
define([ 'react' ], function(React) {
  var GuestPrivacy = React.createClass({
    ...
    render: function() {
      return(
        <div data-title="Privacy - Pibi Help">
          <h1>Pibi - Privacy Policy</h1>

          <p>This Privacy Policy governs the manner in which Algol Labs collects, uses, maintains and discloses information collected from users (each, a "User") of the <a href="https://www.pibiapp.com">Pibi</a>&trade; service ("Site"). This privacy policy applies to the Site and all products and services offered by Algol Labs.</p>
          ...
          Algol Labs may collect and use Users personal information for the following purposes:<br />
          <ul>
          ...
          <b>California Online Privacy Protection Act Compliance</b><br /><br />
          ...
          As part of the California Online Privacy Protection Act, all users of our site may make any changes to their information at anytime by logging into their account preferences section via the Manage -> Account menu button and changing the information found therein.<br /><br />

          <b>Childrens Online Privacy Protection Act Compliance</b><br /><br />
          ...
          Algol Labs has the discretion to update this privacy policy at any time. When we do, we will revise the updated date at the bottom of this page and send you an email. We encourage Users to frequently check this page for any changes to stay informed about how we are helping to protect the personal information we collect. You acknowledge and agree that it is your responsibility to review this privacy policy periodically and become aware of modifications.<br /><br />

          <b>Your acceptance of these terms</b><br /><br />

          By using this Site, you signify your acceptance of this policy and <a href="https://www.pibiapp.com/terms">terms of service</a>. If you do not agree to this policy, please do not use our Site. Your continued use of the Site following the posting of changes to this policy will be deemed your acceptance of those changes.<br /><br />

          <b>Contacting us</b><br /><br />

          If you have any questions about this Privacy Policy, the practices of this site, or your dealings with this site, please contact us at:<br />
          <a href="http://www.algollabs.com">Algol Labs</a><br />
          <a href="http://www.algollabs.com">http://www.algollabs.com</a><br />
          Al-Mansur District #73,
          Urdunn St. 11941
          Amman, Jordan<br />
          +962797710145<br />
          hi@algollabs.com<br />
          <br />
          This document was last updated on December 30, 2012<br /><br />
        </div>
      );
    }
  });
